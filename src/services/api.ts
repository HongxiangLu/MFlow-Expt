...
import type { ChatRequest, ChatSseErrorEvent, ChatSseFrame, GraphQueryRequest, GraphResponse } from '../types'
...
export const apiBaseUrl = import.meta.env.VITE_API_BASE_URL || 'http://192.168.1.157:8000'
